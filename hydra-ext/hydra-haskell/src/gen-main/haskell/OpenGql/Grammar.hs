...
type GraphInitializer = GraphExpression
...
type BindingTableInitializer = BindingTableExpression
...
type ValueInitializer = ValueExpression
...
type NestedBindingTableQuerySpecification = NestedQuerySpecification
